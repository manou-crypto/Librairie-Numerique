    ...
    <Modal open={open} onClose={onClose} title="Encaissement" size="sm">
      <div className="space-y-5">
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 text-center">
          ...
          <p className="text-4xl font-bold tabular-nums text-primary">{total.toLocaleString('fr-FR', { minimumFractionDigits: 2 })} FCFA</p>
        </div>
        <div>
        ...
        {mode === 'especes' && (
          <div className="space-y-3 fade-in">
            <div>
              <label className="block text-xs font-semibold text-foreground mb-1.5">Montant reçu (FCFA)</label>
