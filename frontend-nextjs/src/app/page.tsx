...
const HERO_SLIDES = [
  {
    ...
    subtitle: 'Des éditions d’exception sélectionnées pour inspirer votre quotidien et nourrir votre esprit.',
    ctaLabel: 'MEILLEURES VENTES',
    ctaLink: '/catalogue',
    bgGradient: 'from-amber-950/80 via-stone-900/60 to-black/70',
    bgImage: 'https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=2000&q=80',
  },
  {
    id: 2,
    ...
    subtitle: 'Manuels de référence, sciences, essais et guides pratiques pour tous les curieux et étudiants.',
    ctaLabel: 'UNIVERS SAVOIRS & ÉTUDES',
    ctaLink: '/catalogue',
    bgGradient: 'from-slate-950/85 via-stone-900/60 to-slate-900/80',
    bgImage: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?auto=format&fit=crop&w=2000&q=80',
  },
  {
    id: 3,
    ...
    subtitle: 'Plongez dans les plus grands récits contemporains, romans et bandes dessinées captivantes.',
    ctaLabel: 'DÉCOUVRIR LES NOUVEAUTÉS',
    ctaLink: '/catalogue',
    bgGradient: 'from-stone-950/80 via-neutral-900/60 to-black/80',
    bgImage: 'https://images.unsplash.com/photo-1507842229456-1cb7d55f0535?auto=format&fit=crop&w=2000&q=80',
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-18 flex items-center justify-between gap-6">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-[13px] font-medium text-slate-700 dark:text-slate-300">
              <Link href="/catalogue" className="hover:text-slate-950 dark:hover:text-white transition-colors">
                À la une
              </Link>
              <Link href="/catalogue?category=Romans" className="hover:text-slate-950 dark:hover:text-white transition-colors">
                Romans &amp; Récits
              </Link>
              <Link href="/catalogue?category=Scolaire" className="hover:text-slate-950 dark:hover:text-white transition-colors">
                Scolaire &amp; Études
              </Link>
              <Link href="/catalogue?category=Savoirs" className="hover:text-slate-950 dark:hover:text-white transition-colors">
                Savoirs &amp; Essais
              </Link>
              <Link href="/catalogue?category=Jeunesse" className="hover:text-slate-950 dark:hover:text-white transition-colors">
                Jeunesse &amp; BD
              </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="relative z-10 space-y-1">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-amber-400">Romans &amp; Littérature</span>
                <h3 className="text-xl font-bold">Grands Récits &amp; Auteurs</h3>
                <p className="text-xs text-slate-300 font-light line-clamp-1">Les romans contemporains et classiques à ne pas manquer.</p>
              </div>
            </Link>
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
                style={{ backgroundImage: `url('https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fit=crop&w=800&q=80')` }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
              <div className="relative z-10 space-y-1">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-sky-400">Études &amp; Recherche</span>
                <h3 className="text-xl font-bold">Manuels &amp; Savoirs</h3>
                <p className="text-xs text-slate-300 font-light line-clamp-1">Les manuels scolaires et essais universitaires de référence.</p>
              </div>
            </Link>
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
                style={{ backgroundImage: `url('https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=800&q=80')` }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
              <div className="relative z-10 space-y-1">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-emerald-400">Culture &amp; Découverte</span>
                <h3 className="text-xl font-bold">Jeunesse &amp; Développement</h3>
                <p className="text-xs text-slate-300 font-light line-clamp-1">Albums illustrés, éveil, BD et croissance personnelle.</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
              <div className="relative z-10 space-y-1">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-violet-400">Savoirs &amp; Société</span>
                <h3 className="text-xl font-bold">Essais &amp; Philosophie</h3>
                <p className="text-xs text-slate-300 font-light line-clamp-1">Penseurs, débats contemporains, biographies et essais.</p>
              </div>
            </Link>
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
                style={{ backgroundImage: `url('https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?auto=format&fit=crop&w=800&q=80')` }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
              <div className="relative z-10 space-y-1">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-rose-400">Art &amp; Créativité</span>
                <h3 className="text-xl font-bold">Beaux-Arts &amp; Design</h3>
                <p className="text-xs text-slate-300 font-light line-clamp-1">Livres d'art, design graphique, architecture et photographie.</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
              <div className="relative z-10 space-y-1">
                <span className="text-[11px] font-semibold uppercase tracking-wider text-teal-400">Guides &amp; Pratique</span>
                <h3 className="text-xl font-bold">Développement &amp; Bien-être</h3>
                <p className="text-xs text-slate-300 font-light line-clamp-1">Coaching, management, santé et épanouissement personnel.</p>
              </div>
            </Link>
      ...
      <section className="py-16 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center sm:text-left">
          ...
          <div className="space-y-3 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-2xs">
            ...
            <h3 className="text-base font-semibold text-slate-900 dark:text-white">Sélection Rigoureuse</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-normal">
              Chaque ouvrage est vérifié, catalogué et sélectionné auprès d’éditeurs de renom pour vous garantir authenticité et qualité.
            </p>
          </div>
          ...
          <div className="space-y-3 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-2xs">
            ...
            <h3 className="text-base font-semibold text-slate-900 dark:text-white">Disponibilité en Temps Réel</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-normal">
              Notre stock est synchronisé en direct avec notre réseau de librairies pour vous assurer une disponibilité instantanée.
            </p>
          </div>
          ...
          <div className="space-y-3 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-2xs">
            ...
            <h3 className="text-base font-semibold text-slate-900 dark:text-white">Conseil & Espace Pro</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-normal">
              Un espace dédié aux libraires, institutions et passionnés pour gérer facilement leurs approvisionnements et commandes.
            </p>
          </div>
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      {quickViewProduct.stock > 0 ? (
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 text-xs font-medium">
                          ...
                          <span>{quickViewProduct.stock} disponible{quickViewProduct.stock > 1 ? 's' : ''}</span>
                        </div>
                      ) : (
