    ...
    <div className="bg-card border-b border-border px-5 py-3 shrink-0">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <select
          ...
          className="text-sm border border-border rounded-lg px-3 py-2 bg-card text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
        >
        ...
        <span className="text-xs text-muted-foreground whitespace-nowrap">
          {totalFiltered} / {totalAll} produits
        </span>
        ...
        {selectedCount > 0 && (
          <div className="flex items-center gap-2 bg-primary/5 border border-primary/20 rounded-lg px-3 py-1.5 slide-up">
            ...
            <button
              ...
              title="Masquer les produits sélectionnés"
            >
              <EyeOff size={13} />
              Masquer
            </button>
