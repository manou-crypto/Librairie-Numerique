          ...
          <div className="flex items-center gap-1 bg-muted rounded-lg p-1 w-fit">
            {(['ventes', 'achats', 'stocks'] as const).map((t) => (
              <button
                key={t}
                onClick={() => setTab(t)}
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all capitalize ${tab === t ? 'bg-white text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
              >
                {t}
              </button>
            ))}
        ...
        {tab === 'ventes' && (
          ...
          {tab === 'achats' && (
            <div className="py-20 text-center text-muted-foreground flex flex-col items-center justify-center">
              ...
              <h3 className="text-lg font-semibold text-foreground">Rapports d'Achats</h3>
              <p className="text-sm mt-1">Les statistiques détaillées des achats apparaîtront ici.</p>
            </div>
          )}
          ...
          {tab === 'stocks' && (
            <div className="py-20 text-center text-muted-foreground flex flex-col items-center justify-center">
              ...
              <h3 className="text-lg font-semibold text-foreground">Rapports de Stocks</h3>
              <p className="text-sm mt-1">Les mouvements et valorisations des stocks apparaîtront ici.</p>
            </div>
          )}
        </div>
    </AppLayout>
